				...
				generateLabels: function(chart) {
					...
					if (data.labels.length && data.datasets.length) {
						return data.labels.map(function(label, i) {
							...
							//var fill = vote[]
							var stroke = custom.backgroundColor ? custom.backgroundColor : getValueAtIndexOrDefault(ds.backgroundColor, i, arcOpts.backgroundColor);
			...
			onClick: function(e, legendItem) {
				...
				for (i = 0, ilen = (chart.data.datasets || []).length; i < ilen; ++i) {
					...
					if (voted) {
						...
						data.datasets[0].borderWidth[index] = 13;
						data.datasets[0].borderColor[index] = helpers.color(data.datasets[0].backgroundColor[index]).saturate(1).darken(-0).rgbString();
						data.datasets[0].backgroundColor[index] = helpers.color(data.datasets[0].backgroundColor[index]).saturate(1).darken(-0).rgbString();
						voted = false;
						...
						//meta = chart.getDatasetMeta(i);
						//meta.data[index].text = "!meta.data[index].hidden";
					}else{
